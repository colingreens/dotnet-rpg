    ...
    public class FightService : IFightService
    {
        ...
        public async Task<ServiceResponse<AttackResultDto>> SkillAttack(SkillAttackDto request)
        {
            ...
            try
            {
                ...
                if (attacker is null || opponent is null || attacker.Skills is null)
                    throw new Exception("Something fishy is going on here. Do you have a weapon?");
                ...
                ResetWhenDefeated(response, attacker, opponent);

                await _context.SaveChangesAsync();

                response.Data = new AttackResultDto //TODO:auto map this
                {
        ...
        public async Task<ServiceResponse<AttackResultDto>> WeaponAttack(WeaponAttackDto request)
        {
            ...
            try
            {
                ...
                response.Data = new AttackResultDto //TODO: automap this
                {
                    Attacker = attacker.Name,
                    Opponent = opponent.Name,
                    AttackerHP = attacker.HitPoints,
        ...
        private static void ResetWhenDefeated(ServiceResponse<AttackResultDto> response, Character attacker, Character opponent)
        {
            if (opponent.HitPoints <= 0)
            {
